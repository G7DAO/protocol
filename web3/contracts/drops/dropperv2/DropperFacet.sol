 ...
 */
contract DropperFacet is IERC721Receiver, ERC1155Holder, TerminusPermissions, DiamondReentrancyGuard {
    event Claimed(
    ...
    function _claim(
        ...
        require(block.number <= blockDeadline, "Dropper: _claim -- Block deadline exceeded.");
