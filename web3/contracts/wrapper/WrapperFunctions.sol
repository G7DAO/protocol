...
//make abstract when done
contract WrapperFunctions is ERC1155Holder {
    ...
    function wrap1155(address erc1155Contract,address to, uint256 amount, uint256 tokenId) public  returns(address token, uint256 _amount){
    ...
    //make internal after testing
    function unwrap1155(address token, address to, uint256 amount) public  returns(uint256 _amount){
