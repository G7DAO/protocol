...
abstract contract WrapperFunctions is ERC1155Holder, ReentrancyGuard {
    ...
    function wrap1155(address erc1155Contract,address to, uint256 amount, uint256 tokenId) public virtual nonReentrant returns(uint256 _amount){
        address token = IWrapper1155Factory(wrapperFactory).get1155Wrapper(erc1155Contract, tokenId);
    ...
    function unwrap1155(address token, address to, uint256 amount) public virtual nonReentrant returns(uint256 _amount){
