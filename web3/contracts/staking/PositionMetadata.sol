    ...
    function generateSVGForeground(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="Courier New" font-size="40" letter-spacing="0em"><tspan x="260" y="1584">',poolIdString,'</tspan></text>',
                "</g>",
