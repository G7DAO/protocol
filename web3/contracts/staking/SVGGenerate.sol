    ...
    function generateSVGForeground(
        ...
        string memory tokenTypeString = pool.tokenType == 1
            ...
            abi.encodePacked(
                ...
                '<text fill="#FFEFB8" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="28" font-weight="bold" letter-spacing="0em"><tspan x="1674" y="215.182">',poolAdminString,'</tspan></text>',
                '</g>',
                ...
                '<text fill="#7E807E" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="28" font-weight="bold" letter-spacing="0em"><tspan x="260" y="1052.18">', tokenAmountOrIdString, '</tspan></text>',
            '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="80" font-weight="bold" letter-spacing="0em"><tspan x="240" y="1157.18">',amountOrTokenIDString,'</tspan></text>',
                ...
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="40" letter-spacing="0em"><tspan x="260" y="1352.55">', stakeTimestampStr ,'</tspan></text>',
                ...
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="40" letter-spacing="0em"><tspan x="788" y="1352.55">',unlockTimestampStr,'</tspan></text>',
                '<text fill="#7E807E" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="32" letter-spacing="0em"><tspan x="1276" y="1266.14">Cooldown</tspan></text>',
                ...
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="40" letter-spacing="0em"><tspan x="1316" y="1352.55">Initiated at ', cooldownStr,'</tspan></text>',
