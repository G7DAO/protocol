    ...
    function generateSVGForeground(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<text fill="#7E807E" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="28" font-weight="bold" letter-spacing="0em"><tspan x="260" y="1052.18">',
                tokenAmountOrIdString,
                "</tspan></text>",
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="80" font-weight="bold" letter-spacing="0em"><tspan x="240" y="1157.18">',
                ...
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="40" letter-spacing="0em"><tspan x="260" y="1352.55">',
                stakeTimestampStr,
                "</tspan></text>",
                ...
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="40" letter-spacing="0em"><tspan x="788" y="1352.55">',
                unlockTimestampStr,
                "</tspan></text>",
                ...
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="40" letter-spacing="0em"><tspan x="1316" y="1352.55">Initiated at ',
                cooldownStr,
                "</tspan></text>",
                ...
                '<text fill="#FFEFB8" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="28" font-weight="bold" letter-spacing="0em"><tspan x="260" y="1495.68">',
                tokenTypeString,
                "</tspan></text>",
                '<text fill="#CBCFCB" xml:space="preserve" style="white-space: pre" font-family="\'Inter\'" font-size="32" letter-spacing="0em"><tspan x="388" y="1477.77">',
                poolIdString,
                "</tspan></text>",
                "</g>",
