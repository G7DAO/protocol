...
func DiamondSetupV1(txOpts *bind.TransactOpts, client *ethclient.Client, owner common.Address, diamondCutAddress common.Address, diamondLoupeAddress common.Address, ownershipAddress common.Address, dropperAddress common.Address) (DiamondConfiguration, error) {
...
func CreateV1Command() *cobra.Command {
	...
	var terminusAdminPoolId string
	var contractOwnerRaw string
	var diamondCutFacet, diamondLoupeFacet, ownershipFacet, DropperFacet common.Address
	var diamondCutFacetRaw, diamondLoupeFacetRaw, ownershipFacetRaw, DropperFacetRaw string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			deployedConfiguration, setupErr := DiamondSetupV1(transactionOpts, client, contractOwner, diamondCutFacet, diamondLoupeFacet, ownershipFacet, DropperFacet)
			if setupErr != nil {
				return setupErr
			}
