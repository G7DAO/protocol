...
bindings/Terminus.go: hardhat
	...
	mkdir -p bindings/security/Terminus/diamond/Diamond
	seer evm generate --package DiamondTerminus --output bindings/security/Terminus/diamond/DiamondTerminus.go --hardhat web3/artifacts/contracts/security/terminus/diamond/DiamondTerminus.sol/DiamondTerminus.json --cli --struct DiamondTermiuns
...
bindings/Dropper/DropperV2.go: hardhat
	...
	mkdir -p bindings/Dropper/DropperV2/DiamondDropperV2
	seer evm generate --package DiamondDropperV2 --output bindings/Dropper/DropperV2/DiamondDropperV2/DiamondDropperV2.go --hardhat web3/artifacts/contracts/drops/dropperv2/diamond/DiamondDropperV2.sol/DiamondDropperV2.json --cli --struct DiamondDropperV2	
...
bindings/Dropper/DropperV3.go: hardhat
	...
	seer evm generate --package DiamondDropperV3 --output bindings/Dropper/DropperV3/Diamond/DiamondDropperV3.go --hardhat web3/artifacts/contracts/drops/dropper-V3/diamond/DiamondDropperV3.sol/DiamondDropperV3.json --cli --struct DiamondDropperV3
