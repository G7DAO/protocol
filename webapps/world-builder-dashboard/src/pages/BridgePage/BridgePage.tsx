      ...
      <Box px='32px' bg={'#FCFCFD'} h={'100vh'} pt={'5px'}>
        {/*<ContentHeader name='Bridge' tabs={{ list: [], value: location.pathname }} style={""}></ContentHeader>*/}
          ...
          <div className={styles.navigationContainer}>
              <button
                  className={location.pathname === '/bridge' ? styles.selectedNavigationButton : styles.unselectedNavigationButton}
                  onClick={() => navigate('/bridge')}
              >
                  Transfer
              </button>
              <button
                  className={location.pathname === '/bridge/transactions' ? styles.selectedNavigationButton : styles.unselectedNavigationButton}
