...
const benefits = [
  {
    ...
    description: '<p>Bootstrap your game with access to <span style="font-weight:bold;">250,000+</span> citizens and counting</p>'
  },
  {
        ...
        <div className={styles.cards}>
          {benefits.map((benefit, index) => (
            <div className={styles.card} key={index}>
              ...
              <div className={styles.cardDescription} dangerouslySetInnerHTML={{ __html: benefit.description }} />
            </div>
          ))}
        </div>
      </div>
