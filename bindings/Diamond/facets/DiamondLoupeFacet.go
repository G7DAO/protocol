...
// seer version: 0.1.3
// seer command: seer evm generate --package DiamondLoupeFacet --cli --struct DiamondLoupeFacet --output bindings/Diamond/facets/DiamondLoupeFacet.go
...
func CreateFacetFunctionSelectorsCommand() *cobra.Command {
	...
	cmd.Flags().StringVar(&facetRaw, "facet", "", "facet argument")
...
func CreateFacetAddressCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		PreRunE: func(cmd *cobra.Command, args []string) error {
			...
			var hexDecodefunctionSelectorErr error

			var intermediatefunctionSelectorLeaf []byte
			intermediatefunctionSelectorLeaf, hexDecodefunctionSelectorErr = hex.DecodeString(functionSelectorRaw)
			if hexDecodefunctionSelectorErr != nil {
				return hexDecodefunctionSelectorErr
			}
			functionSelector = [4]byte(intermediatefunctionSelectorLeaf[:4])
	...
	cmd.Flags().StringVar(&functionSelectorRaw, "function-selector", "", "function-selector argument")
