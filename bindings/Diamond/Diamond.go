...
func CreateDiamondDeploymentCommand() *cobra.Command {
	...
	cmd.Flags().StringVar(&contractOwnerRaw, "contract-owner", "", "contract-owner argument")
	cmd.Flags().StringVar(&diamondCutFacetRaw, "diamond-cut-facet", "", "diamond-cut-facet argument")
