...
// seer version: 0.1.3
// seer command: seer evm generate --package ArbitrumOrbitRouter --cli --struct ArbitrumOrbitRouter
// Code generated - DO NOT EDIT.
// This file is a generated binding and any manual changes will be lost.

package ArbitrumOrbitRouter
...
// ArbitrumOrbitRouterMetaData contains all meta data concerning the ArbitrumOrbitRouter contract.
var ArbitrumOrbitRouterMetaData = &bind.MetaData{
...
// ArbitrumOrbitRouterABI is the input ABI used to generate the binding from.
// Deprecated: Use ArbitrumOrbitRouterMetaData.ABI instead.
var ArbitrumOrbitRouterABI = ArbitrumOrbitRouterMetaData.ABI

// ArbitrumOrbitRouterBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use ArbitrumOrbitRouterMetaData.Bin instead.
var ArbitrumOrbitRouterBin = ArbitrumOrbitRouterMetaData.Bin

// DeployArbitrumOrbitRouter deploys a new Ethereum contract, binding an instance of ArbitrumOrbitRouter to it.
func DeployArbitrumOrbitRouter(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *ArbitrumOrbitRouter, error) {
	parsed, err := ArbitrumOrbitRouterMetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ArbitrumOrbitRouterBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &ArbitrumOrbitRouter{ArbitrumOrbitRouterCaller: ArbitrumOrbitRouterCaller{contract: contract}, ArbitrumOrbitRouterTransactor: ArbitrumOrbitRouterTransactor{contract: contract}, ArbitrumOrbitRouterFilterer: ArbitrumOrbitRouterFilterer{contract: contract}}, nil
}

// ArbitrumOrbitRouter is an auto generated Go binding around an Ethereum contract.
type ArbitrumOrbitRouter struct {
	ArbitrumOrbitRouterCaller     // Read-only binding to the contract
	ArbitrumOrbitRouterTransactor // Write-only binding to the contract
	ArbitrumOrbitRouterFilterer   // Log filterer for contract events
}

// ArbitrumOrbitRouterCaller is an auto generated read-only Go binding around an Ethereum contract.
type ArbitrumOrbitRouterCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbitrumOrbitRouterTransactor is an auto generated write-only Go binding around an Ethereum contract.
type ArbitrumOrbitRouterTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbitrumOrbitRouterFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ArbitrumOrbitRouterFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ArbitrumOrbitRouterSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type ArbitrumOrbitRouterSession struct {
	Contract     *ArbitrumOrbitRouter // Generic contract binding to set the session for
	CallOpts     bind.CallOpts        // Call options to use throughout this session
	TransactOpts bind.TransactOpts    // Transaction auth options to use throughout this session
}

// ArbitrumOrbitRouterCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type ArbitrumOrbitRouterCallerSession struct {
	Contract *ArbitrumOrbitRouterCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts              // Call options to use throughout this session
}

// ArbitrumOrbitRouterTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type ArbitrumOrbitRouterTransactorSession struct {
	Contract     *ArbitrumOrbitRouterTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts              // Transaction auth options to use throughout this session
}

// ArbitrumOrbitRouterRaw is an auto generated low-level Go binding around an Ethereum contract.
type ArbitrumOrbitRouterRaw struct {
	Contract *ArbitrumOrbitRouter // Generic contract binding to access the raw methods on
}

// ArbitrumOrbitRouterCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type ArbitrumOrbitRouterCallerRaw struct {
	Contract *ArbitrumOrbitRouterCaller // Generic read-only contract binding to access the raw methods on
}

// ArbitrumOrbitRouterTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type ArbitrumOrbitRouterTransactorRaw struct {
	Contract *ArbitrumOrbitRouterTransactor // Generic write-only contract binding to access the raw methods on
}

// NewArbitrumOrbitRouter creates a new instance of ArbitrumOrbitRouter, bound to a specific deployed contract.
func NewArbitrumOrbitRouter(address common.Address, backend bind.ContractBackend) (*ArbitrumOrbitRouter, error) {
	contract, err := bindArbitrumOrbitRouter(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouter{ArbitrumOrbitRouterCaller: ArbitrumOrbitRouterCaller{contract: contract}, ArbitrumOrbitRouterTransactor: ArbitrumOrbitRouterTransactor{contract: contract}, ArbitrumOrbitRouterFilterer: ArbitrumOrbitRouterFilterer{contract: contract}}, nil
}

// NewArbitrumOrbitRouterCaller creates a new read-only instance of ArbitrumOrbitRouter, bound to a specific deployed contract.
func NewArbitrumOrbitRouterCaller(address common.Address, caller bind.ContractCaller) (*ArbitrumOrbitRouterCaller, error) {
	contract, err := bindArbitrumOrbitRouter(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterCaller{contract: contract}, nil
}

// NewArbitrumOrbitRouterTransactor creates a new write-only instance of ArbitrumOrbitRouter, bound to a specific deployed contract.
func NewArbitrumOrbitRouterTransactor(address common.Address, transactor bind.ContractTransactor) (*ArbitrumOrbitRouterTransactor, error) {
	contract, err := bindArbitrumOrbitRouter(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterTransactor{contract: contract}, nil
}

// NewArbitrumOrbitRouterFilterer creates a new log filterer instance of ArbitrumOrbitRouter, bound to a specific deployed contract.
func NewArbitrumOrbitRouterFilterer(address common.Address, filterer bind.ContractFilterer) (*ArbitrumOrbitRouterFilterer, error) {
	contract, err := bindArbitrumOrbitRouter(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterFilterer{contract: contract}, nil
}

// bindArbitrumOrbitRouter binds a generic wrapper to an already deployed contract.
func bindArbitrumOrbitRouter(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := ArbitrumOrbitRouterMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// returns.
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ArbitrumOrbitRouter.Contract.ArbitrumOrbitRouterCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.ArbitrumOrbitRouterTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.ArbitrumOrbitRouterTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ArbitrumOrbitRouter.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.contract.Transact(opts, method, params...)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) CalculateL2TokenAddress(opts *bind.CallOpts, l1ERC20 common.Address) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "calculateL2TokenAddress", l1ERC20)
...
//
// Solidity: function calculateL2TokenAddress(address l1ERC20) view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) CalculateL2TokenAddress(l1ERC20 common.Address) (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.CalculateL2TokenAddress(&_ArbitrumOrbitRouter.CallOpts, l1ERC20)
}

// CalculateL2TokenAddress is a free data retrieval call binding the contract method 0xa7e28d48.
//
// Solidity: function calculateL2TokenAddress(address l1ERC20) view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) CalculateL2TokenAddress(l1ERC20 common.Address) (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.CalculateL2TokenAddress(&_ArbitrumOrbitRouter.CallOpts, l1ERC20)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) CounterpartGateway(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "counterpartGateway")
...
//
// Solidity: function counterpartGateway() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) CounterpartGateway() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.CounterpartGateway(&_ArbitrumOrbitRouter.CallOpts)
}

// CounterpartGateway is a free data retrieval call binding the contract method 0x2db09c1c.
//
// Solidity: function counterpartGateway() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) CounterpartGateway() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.CounterpartGateway(&_ArbitrumOrbitRouter.CallOpts)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) DefaultGateway(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "defaultGateway")
...
//
// Solidity: function defaultGateway() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) DefaultGateway() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.DefaultGateway(&_ArbitrumOrbitRouter.CallOpts)
}

// DefaultGateway is a free data retrieval call binding the contract method 0x03295802.
//
// Solidity: function defaultGateway() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) DefaultGateway() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.DefaultGateway(&_ArbitrumOrbitRouter.CallOpts)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) GetGateway(opts *bind.CallOpts, _token common.Address) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "getGateway", _token)
...
//
// Solidity: function getGateway(address _token) view returns(address gateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) GetGateway(_token common.Address) (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.GetGateway(&_ArbitrumOrbitRouter.CallOpts, _token)
}

// GetGateway is a free data retrieval call binding the contract method 0xbda009fe.
//
// Solidity: function getGateway(address _token) view returns(address gateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) GetGateway(_token common.Address) (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.GetGateway(&_ArbitrumOrbitRouter.CallOpts, _token)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) GetOutboundCalldata(opts *bind.CallOpts, _token common.Address, _from common.Address, _to common.Address, _amount *big.Int, _data []byte) ([]byte, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "getOutboundCalldata", _token, _from, _to, _amount, _data)
...
//
// Solidity: function getOutboundCalldata(address _token, address _from, address _to, uint256 _amount, bytes _data) view returns(bytes)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) GetOutboundCalldata(_token common.Address, _from common.Address, _to common.Address, _amount *big.Int, _data []byte) ([]byte, error) {
	return _ArbitrumOrbitRouter.Contract.GetOutboundCalldata(&_ArbitrumOrbitRouter.CallOpts, _token, _from, _to, _amount, _data)
}

// GetOutboundCalldata is a free data retrieval call binding the contract method 0xa0c76a96.
//
// Solidity: function getOutboundCalldata(address _token, address _from, address _to, uint256 _amount, bytes _data) view returns(bytes)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) GetOutboundCalldata(_token common.Address, _from common.Address, _to common.Address, _amount *big.Int, _data []byte) ([]byte, error) {
	return _ArbitrumOrbitRouter.Contract.GetOutboundCalldata(&_ArbitrumOrbitRouter.CallOpts, _token, _from, _to, _amount, _data)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) Inbox(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "inbox")
...
//
// Solidity: function inbox() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) Inbox() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Inbox(&_ArbitrumOrbitRouter.CallOpts)
}

// Inbox is a free data retrieval call binding the contract method 0xfb0e722b.
//
// Solidity: function inbox() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) Inbox() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Inbox(&_ArbitrumOrbitRouter.CallOpts)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) L1TokenToGateway(opts *bind.CallOpts, arg0 common.Address) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "l1TokenToGateway", arg0)
...
//
// Solidity: function l1TokenToGateway(address ) view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) L1TokenToGateway(arg0 common.Address) (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.L1TokenToGateway(&_ArbitrumOrbitRouter.CallOpts, arg0)
}

// L1TokenToGateway is a free data retrieval call binding the contract method 0xed08fdc6.
//
// Solidity: function l1TokenToGateway(address ) view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) L1TokenToGateway(arg0 common.Address) (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.L1TokenToGateway(&_ArbitrumOrbitRouter.CallOpts, arg0)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "owner")
...
//
// Solidity: function owner() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) Owner() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Owner(&_ArbitrumOrbitRouter.CallOpts)
}

// Owner is a free data retrieval call binding the contract method 0x8da5cb5b.
//
// Solidity: function owner() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) Owner() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Owner(&_ArbitrumOrbitRouter.CallOpts)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) Router(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "router")
...
//
// Solidity: function router() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) Router() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Router(&_ArbitrumOrbitRouter.CallOpts)
}

// Router is a free data retrieval call binding the contract method 0xf887ea40.
//
// Solidity: function router() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) Router() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Router(&_ArbitrumOrbitRouter.CallOpts)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "supportsInterface", interfaceId)
...
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _ArbitrumOrbitRouter.Contract.SupportsInterface(&_ArbitrumOrbitRouter.CallOpts, interfaceId)
}

// SupportsInterface is a free data retrieval call binding the contract method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _ArbitrumOrbitRouter.Contract.SupportsInterface(&_ArbitrumOrbitRouter.CallOpts, interfaceId)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCaller) Whitelist(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ArbitrumOrbitRouter.contract.Call(opts, &out, "whitelist")
...
//
// Solidity: function whitelist() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) Whitelist() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Whitelist(&_ArbitrumOrbitRouter.CallOpts)
}

// Whitelist is a free data retrieval call binding the contract method 0x93e59dc1.
//
// Solidity: function whitelist() view returns(address)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterCallerSession) Whitelist() (common.Address, error) {
	return _ArbitrumOrbitRouter.Contract.Whitelist(&_ArbitrumOrbitRouter.CallOpts)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) FinalizeInboundTransfer(opts *bind.TransactOpts, arg0 common.Address, arg1 common.Address, arg2 common.Address, arg3 *big.Int, arg4 []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "finalizeInboundTransfer", arg0, arg1, arg2, arg3, arg4)
}

// FinalizeInboundTransfer is a paid mutator transaction binding the contract method 0x2e567b36.
//
// Solidity: function finalizeInboundTransfer(address , address , address , uint256 , bytes ) payable returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) FinalizeInboundTransfer(arg0 common.Address, arg1 common.Address, arg2 common.Address, arg3 *big.Int, arg4 []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.FinalizeInboundTransfer(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3, arg4)
}

// FinalizeInboundTransfer is a paid mutator transaction binding the contract method 0x2e567b36.
//
// Solidity: function finalizeInboundTransfer(address , address , address , uint256 , bytes ) payable returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) FinalizeInboundTransfer(arg0 common.Address, arg1 common.Address, arg2 common.Address, arg3 *big.Int, arg4 []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.FinalizeInboundTransfer(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3, arg4)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) Initialize(opts *bind.TransactOpts, _owner common.Address, _defaultGateway common.Address, arg2 common.Address, _counterpartGateway common.Address, _inbox common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "initialize", _owner, _defaultGateway, arg2, _counterpartGateway, _inbox)
}

// Initialize is a paid mutator transaction binding the contract method 0x1459457a.
//
// Solidity: function initialize(address _owner, address _defaultGateway, address , address _counterpartGateway, address _inbox) returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) Initialize(_owner common.Address, _defaultGateway common.Address, arg2 common.Address, _counterpartGateway common.Address, _inbox common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.Initialize(&_ArbitrumOrbitRouter.TransactOpts, _owner, _defaultGateway, arg2, _counterpartGateway, _inbox)
}

// Initialize is a paid mutator transaction binding the contract method 0x1459457a.
//
// Solidity: function initialize(address _owner, address _defaultGateway, address , address _counterpartGateway, address _inbox) returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) Initialize(_owner common.Address, _defaultGateway common.Address, arg2 common.Address, _counterpartGateway common.Address, _inbox common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.Initialize(&_ArbitrumOrbitRouter.TransactOpts, _owner, _defaultGateway, arg2, _counterpartGateway, _inbox)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) OutboundTransfer(opts *bind.TransactOpts, _token common.Address, _to common.Address, _amount *big.Int, _maxGas *big.Int, _gasPriceBid *big.Int, _data []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "outboundTransfer", _token, _to, _amount, _maxGas, _gasPriceBid, _data)
}

// OutboundTransfer is a paid mutator transaction binding the contract method 0xd2ce7d65.
//
// Solidity: function outboundTransfer(address _token, address _to, uint256 _amount, uint256 _maxGas, uint256 _gasPriceBid, bytes _data) payable returns(bytes)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) OutboundTransfer(_token common.Address, _to common.Address, _amount *big.Int, _maxGas *big.Int, _gasPriceBid *big.Int, _data []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.OutboundTransfer(&_ArbitrumOrbitRouter.TransactOpts, _token, _to, _amount, _maxGas, _gasPriceBid, _data)
}

// OutboundTransfer is a paid mutator transaction binding the contract method 0xd2ce7d65.
//
// Solidity: function outboundTransfer(address _token, address _to, uint256 _amount, uint256 _maxGas, uint256 _gasPriceBid, bytes _data) payable returns(bytes)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) OutboundTransfer(_token common.Address, _to common.Address, _amount *big.Int, _maxGas *big.Int, _gasPriceBid *big.Int, _data []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.OutboundTransfer(&_ArbitrumOrbitRouter.TransactOpts, _token, _to, _amount, _maxGas, _gasPriceBid, _data)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) OutboundTransferCustomRefund(opts *bind.TransactOpts, _token common.Address, _refundTo common.Address, _to common.Address, _amount *big.Int, _maxGas *big.Int, _gasPriceBid *big.Int, _data []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "outboundTransferCustomRefund", _token, _refundTo, _to, _amount, _maxGas, _gasPriceBid, _data)
}

// OutboundTransferCustomRefund is a paid mutator transaction binding the contract method 0x4fb1a07b.
//
// Solidity: function outboundTransferCustomRefund(address _token, address _refundTo, address _to, uint256 _amount, uint256 _maxGas, uint256 _gasPriceBid, bytes _data) payable returns(bytes)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) OutboundTransferCustomRefund(_token common.Address, _refundTo common.Address, _to common.Address, _amount *big.Int, _maxGas *big.Int, _gasPriceBid *big.Int, _data []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.OutboundTransferCustomRefund(&_ArbitrumOrbitRouter.TransactOpts, _token, _refundTo, _to, _amount, _maxGas, _gasPriceBid, _data)
}

// OutboundTransferCustomRefund is a paid mutator transaction binding the contract method 0x4fb1a07b.
//
// Solidity: function outboundTransferCustomRefund(address _token, address _refundTo, address _to, uint256 _amount, uint256 _maxGas, uint256 _gasPriceBid, bytes _data) payable returns(bytes)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) OutboundTransferCustomRefund(_token common.Address, _refundTo common.Address, _to common.Address, _amount *big.Int, _maxGas *big.Int, _gasPriceBid *big.Int, _data []byte) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.OutboundTransferCustomRefund(&_ArbitrumOrbitRouter.TransactOpts, _token, _refundTo, _to, _amount, _maxGas, _gasPriceBid, _data)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) PostUpgradeInit(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "postUpgradeInit")
}

// PostUpgradeInit is a paid mutator transaction binding the contract method 0x95fcea78.
//
// Solidity: function postUpgradeInit() returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) PostUpgradeInit() (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.PostUpgradeInit(&_ArbitrumOrbitRouter.TransactOpts)
}

// PostUpgradeInit is a paid mutator transaction binding the contract method 0x95fcea78.
//
// Solidity: function postUpgradeInit() returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) PostUpgradeInit() (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.PostUpgradeInit(&_ArbitrumOrbitRouter.TransactOpts)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetDefaultGateway(opts *bind.TransactOpts, arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setDefaultGateway", arg0, arg1, arg2, arg3)
}

// SetDefaultGateway is a paid mutator transaction binding the contract method 0x5625a952.
//
// Solidity: function setDefaultGateway(address , uint256 , uint256 , uint256 ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetDefaultGateway(arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetDefaultGateway(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3)
}

// SetDefaultGateway is a paid mutator transaction binding the contract method 0x5625a952.
//
// Solidity: function setDefaultGateway(address , uint256 , uint256 , uint256 ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetDefaultGateway(arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetDefaultGateway(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetDefaultGateway0(opts *bind.TransactOpts, newL1DefaultGateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setDefaultGateway0", newL1DefaultGateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}

// SetDefaultGateway0 is a paid mutator transaction binding the contract method 0xc9a96997.
//
// Solidity: function setDefaultGateway(address newL1DefaultGateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetDefaultGateway0(newL1DefaultGateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetDefaultGateway0(&_ArbitrumOrbitRouter.TransactOpts, newL1DefaultGateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}

// SetDefaultGateway0 is a paid mutator transaction binding the contract method 0xc9a96997.
//
// Solidity: function setDefaultGateway(address newL1DefaultGateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetDefaultGateway0(newL1DefaultGateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetDefaultGateway0(&_ArbitrumOrbitRouter.TransactOpts, newL1DefaultGateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetGateway(opts *bind.TransactOpts, arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int, arg4 common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setGateway", arg0, arg1, arg2, arg3, arg4)
}

// SetGateway is a paid mutator transaction binding the contract method 0x2d67b72d.
//
// Solidity: function setGateway(address , uint256 , uint256 , uint256 , address ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetGateway(arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int, arg4 common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3, arg4)
}

// SetGateway is a paid mutator transaction binding the contract method 0x2d67b72d.
//
// Solidity: function setGateway(address , uint256 , uint256 , uint256 , address ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetGateway(arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int, arg4 common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3, arg4)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetGateway0(opts *bind.TransactOpts, _gateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _creditBackAddress common.Address, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setGateway0", _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _creditBackAddress, _feeAmount)
}

// SetGateway0 is a paid mutator transaction binding the contract method 0xd7f7459c.
//
// Solidity: function setGateway(address _gateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, address _creditBackAddress, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetGateway0(_gateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _creditBackAddress common.Address, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway0(&_ArbitrumOrbitRouter.TransactOpts, _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _creditBackAddress, _feeAmount)
}

// SetGateway0 is a paid mutator transaction binding the contract method 0xd7f7459c.
//
// Solidity: function setGateway(address _gateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, address _creditBackAddress, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetGateway0(_gateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _creditBackAddress common.Address, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway0(&_ArbitrumOrbitRouter.TransactOpts, _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _creditBackAddress, _feeAmount)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetGateway1(opts *bind.TransactOpts, _gateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setGateway1", _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}

// SetGateway1 is a paid mutator transaction binding the contract method 0xdc121927.
//
// Solidity: function setGateway(address _gateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetGateway1(_gateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway1(&_ArbitrumOrbitRouter.TransactOpts, _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}

// SetGateway1 is a paid mutator transaction binding the contract method 0xdc121927.
//
// Solidity: function setGateway(address _gateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetGateway1(_gateway common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway1(&_ArbitrumOrbitRouter.TransactOpts, _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetGateway2(opts *bind.TransactOpts, arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setGateway2", arg0, arg1, arg2, arg3)
}

// SetGateway2 is a paid mutator transaction binding the contract method 0xdd614569.
//
// Solidity: function setGateway(address , uint256 , uint256 , uint256 ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetGateway2(arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway2(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3)
}

// SetGateway2 is a paid mutator transaction binding the contract method 0xdd614569.
//
// Solidity: function setGateway(address , uint256 , uint256 , uint256 ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetGateway2(arg0 common.Address, arg1 *big.Int, arg2 *big.Int, arg3 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateway2(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetGateways(opts *bind.TransactOpts, _token []common.Address, _gateway []common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setGateways", _token, _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}

// SetGateways is a paid mutator transaction binding the contract method 0x55654af8.
//
// Solidity: function setGateways(address[] _token, address[] _gateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetGateways(_token []common.Address, _gateway []common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateways(&_ArbitrumOrbitRouter.TransactOpts, _token, _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}

// SetGateways is a paid mutator transaction binding the contract method 0x55654af8.
//
// Solidity: function setGateways(address[] _token, address[] _gateway, uint256 _maxGas, uint256 _gasPriceBid, uint256 _maxSubmissionCost, uint256 _feeAmount) returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetGateways(_token []common.Address, _gateway []common.Address, _maxGas *big.Int, _gasPriceBid *big.Int, _maxSubmissionCost *big.Int, _feeAmount *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateways(&_ArbitrumOrbitRouter.TransactOpts, _token, _gateway, _maxGas, _gasPriceBid, _maxSubmissionCost, _feeAmount)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetGateways0(opts *bind.TransactOpts, arg0 []common.Address, arg1 []common.Address, arg2 *big.Int, arg3 *big.Int, arg4 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setGateways0", arg0, arg1, arg2, arg3, arg4)
}

// SetGateways0 is a paid mutator transaction binding the contract method 0x658b53f4.
//
// Solidity: function setGateways(address[] , address[] , uint256 , uint256 , uint256 ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetGateways0(arg0 []common.Address, arg1 []common.Address, arg2 *big.Int, arg3 *big.Int, arg4 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateways0(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3, arg4)
}

// SetGateways0 is a paid mutator transaction binding the contract method 0x658b53f4.
//
// Solidity: function setGateways(address[] , address[] , uint256 , uint256 , uint256 ) payable returns(uint256)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetGateways0(arg0 []common.Address, arg1 []common.Address, arg2 *big.Int, arg3 *big.Int, arg4 *big.Int) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetGateways0(&_ArbitrumOrbitRouter.TransactOpts, arg0, arg1, arg2, arg3, arg4)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) SetOwner(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "setOwner", newOwner)
}

// SetOwner is a paid mutator transaction binding the contract method 0x13af4035.
//
// Solidity: function setOwner(address newOwner) returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) SetOwner(newOwner common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetOwner(&_ArbitrumOrbitRouter.TransactOpts, newOwner)
}

// SetOwner is a paid mutator transaction binding the contract method 0x13af4035.
//
// Solidity: function setOwner(address newOwner) returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) SetOwner(newOwner common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.SetOwner(&_ArbitrumOrbitRouter.TransactOpts, newOwner)
}
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactor) UpdateWhitelistSource(opts *bind.TransactOpts, newSource common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.contract.Transact(opts, "updateWhitelistSource", newSource)
}

// UpdateWhitelistSource is a paid mutator transaction binding the contract method 0x47466f98.
//
// Solidity: function updateWhitelistSource(address newSource) returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterSession) UpdateWhitelistSource(newSource common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.UpdateWhitelistSource(&_ArbitrumOrbitRouter.TransactOpts, newSource)
}

// UpdateWhitelistSource is a paid mutator transaction binding the contract method 0x47466f98.
//
// Solidity: function updateWhitelistSource(address newSource) returns()
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterTransactorSession) UpdateWhitelistSource(newSource common.Address) (*types.Transaction, error) {
	return _ArbitrumOrbitRouter.Contract.UpdateWhitelistSource(&_ArbitrumOrbitRouter.TransactOpts, newSource)
}

// ArbitrumOrbitRouterDefaultGatewayUpdatedIterator is returned from FilterDefaultGatewayUpdated and is used to iterate over the raw logs and unpacked data for DefaultGatewayUpdated events raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterDefaultGatewayUpdatedIterator struct {
	Event *ArbitrumOrbitRouterDefaultGatewayUpdated // Event containing the contract specifics and raw log
...
func (it *ArbitrumOrbitRouterDefaultGatewayUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbitrumOrbitRouterDefaultGatewayUpdated)
...
func (it *ArbitrumOrbitRouterDefaultGatewayUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbitrumOrbitRouterDefaultGatewayUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbitrumOrbitRouterDefaultGatewayUpdated represents a DefaultGatewayUpdated event raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterDefaultGatewayUpdated struct {
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) FilterDefaultGatewayUpdated(opts *bind.FilterOpts) (*ArbitrumOrbitRouterDefaultGatewayUpdatedIterator, error) {

	logs, sub, err := _ArbitrumOrbitRouter.contract.FilterLogs(opts, "DefaultGatewayUpdated")
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterDefaultGatewayUpdatedIterator{contract: _ArbitrumOrbitRouter.contract, event: "DefaultGatewayUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DefaultGatewayUpdated(address newDefaultGateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) WatchDefaultGatewayUpdated(opts *bind.WatchOpts, sink chan<- *ArbitrumOrbitRouterDefaultGatewayUpdated) (event.Subscription, error) {

	logs, sub, err := _ArbitrumOrbitRouter.contract.WatchLogs(opts, "DefaultGatewayUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ArbitrumOrbitRouterDefaultGatewayUpdated)
				if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "DefaultGatewayUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DefaultGatewayUpdated(address newDefaultGateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) ParseDefaultGatewayUpdated(log types.Log) (*ArbitrumOrbitRouterDefaultGatewayUpdated, error) {
	event := new(ArbitrumOrbitRouterDefaultGatewayUpdated)
	if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "DefaultGatewayUpdated", log); err != nil {
		return nil, err
	}
...
// ArbitrumOrbitRouterGatewaySetIterator is returned from FilterGatewaySet and is used to iterate over the raw logs and unpacked data for GatewaySet events raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterGatewaySetIterator struct {
	Event *ArbitrumOrbitRouterGatewaySet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbitrumOrbitRouterGatewaySetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbitrumOrbitRouterGatewaySet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbitrumOrbitRouterGatewaySetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbitrumOrbitRouterGatewaySetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbitrumOrbitRouterGatewaySet represents a GatewaySet event raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterGatewaySet struct {
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) FilterGatewaySet(opts *bind.FilterOpts, l1Token []common.Address, gateway []common.Address) (*ArbitrumOrbitRouterGatewaySetIterator, error) {
	...
	logs, sub, err := _ArbitrumOrbitRouter.contract.FilterLogs(opts, "GatewaySet", l1TokenRule, gatewayRule)
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterGatewaySetIterator{contract: _ArbitrumOrbitRouter.contract, event: "GatewaySet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event GatewaySet(address indexed l1Token, address indexed gateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) WatchGatewaySet(opts *bind.WatchOpts, sink chan<- *ArbitrumOrbitRouterGatewaySet, l1Token []common.Address, gateway []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbitrumOrbitRouter.contract.WatchLogs(opts, "GatewaySet", l1TokenRule, gatewayRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbitrumOrbitRouterGatewaySet)
				if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "GatewaySet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event GatewaySet(address indexed l1Token, address indexed gateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) ParseGatewaySet(log types.Log) (*ArbitrumOrbitRouterGatewaySet, error) {
	event := new(ArbitrumOrbitRouterGatewaySet)
	if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "GatewaySet", log); err != nil {
		return nil, err
	}
...
// ArbitrumOrbitRouterTransferRoutedIterator is returned from FilterTransferRouted and is used to iterate over the raw logs and unpacked data for TransferRouted events raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterTransferRoutedIterator struct {
	Event *ArbitrumOrbitRouterTransferRouted // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbitrumOrbitRouterTransferRoutedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbitrumOrbitRouterTransferRouted)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbitrumOrbitRouterTransferRoutedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbitrumOrbitRouterTransferRoutedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbitrumOrbitRouterTransferRouted represents a TransferRouted event raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterTransferRouted struct {
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) FilterTransferRouted(opts *bind.FilterOpts, token []common.Address, _userFrom []common.Address, _userTo []common.Address) (*ArbitrumOrbitRouterTransferRoutedIterator, error) {
	...
	logs, sub, err := _ArbitrumOrbitRouter.contract.FilterLogs(opts, "TransferRouted", tokenRule, _userFromRule, _userToRule)
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterTransferRoutedIterator{contract: _ArbitrumOrbitRouter.contract, event: "TransferRouted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TransferRouted(address indexed token, address indexed _userFrom, address indexed _userTo, address gateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) WatchTransferRouted(opts *bind.WatchOpts, sink chan<- *ArbitrumOrbitRouterTransferRouted, token []common.Address, _userFrom []common.Address, _userTo []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ArbitrumOrbitRouter.contract.WatchLogs(opts, "TransferRouted", tokenRule, _userFromRule, _userToRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbitrumOrbitRouterTransferRouted)
				if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "TransferRouted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TransferRouted(address indexed token, address indexed _userFrom, address indexed _userTo, address gateway)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) ParseTransferRouted(log types.Log) (*ArbitrumOrbitRouterTransferRouted, error) {
	event := new(ArbitrumOrbitRouterTransferRouted)
	if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "TransferRouted", log); err != nil {
		return nil, err
	}
...
// ArbitrumOrbitRouterTxToL2Iterator is returned from FilterTxToL2 and is used to iterate over the raw logs and unpacked data for TxToL2 events raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterTxToL2Iterator struct {
	Event *ArbitrumOrbitRouterTxToL2 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbitrumOrbitRouterTxToL2Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbitrumOrbitRouterTxToL2)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbitrumOrbitRouterTxToL2Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbitrumOrbitRouterTxToL2Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbitrumOrbitRouterTxToL2 represents a TxToL2 event raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterTxToL2 struct {
	From   common.Address
	To     common.Address
	SeqNum *big.Int
	Data   []byte
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) FilterTxToL2(opts *bind.FilterOpts, _from []common.Address, _to []common.Address, _seqNum []*big.Int) (*ArbitrumOrbitRouterTxToL2Iterator, error) {
	...
	logs, sub, err := _ArbitrumOrbitRouter.contract.FilterLogs(opts, "TxToL2", _fromRule, _toRule, _seqNumRule)
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterTxToL2Iterator{contract: _ArbitrumOrbitRouter.contract, event: "TxToL2", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TxToL2(address indexed _from, address indexed _to, uint256 indexed _seqNum, bytes _data)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) WatchTxToL2(opts *bind.WatchOpts, sink chan<- *ArbitrumOrbitRouterTxToL2, _from []common.Address, _to []common.Address, _seqNum []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ArbitrumOrbitRouter.contract.WatchLogs(opts, "TxToL2", _fromRule, _toRule, _seqNumRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbitrumOrbitRouterTxToL2)
				if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "TxToL2", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TxToL2(address indexed _from, address indexed _to, uint256 indexed _seqNum, bytes _data)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) ParseTxToL2(log types.Log) (*ArbitrumOrbitRouterTxToL2, error) {
	event := new(ArbitrumOrbitRouterTxToL2)
	if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "TxToL2", log); err != nil {
		return nil, err
	}
...
// ArbitrumOrbitRouterWhitelistSourceUpdatedIterator is returned from FilterWhitelistSourceUpdated and is used to iterate over the raw logs and unpacked data for WhitelistSourceUpdated events raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterWhitelistSourceUpdatedIterator struct {
	Event *ArbitrumOrbitRouterWhitelistSourceUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ArbitrumOrbitRouterWhitelistSourceUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ArbitrumOrbitRouterWhitelistSourceUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ArbitrumOrbitRouterWhitelistSourceUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ArbitrumOrbitRouterWhitelistSourceUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ArbitrumOrbitRouterWhitelistSourceUpdated represents a WhitelistSourceUpdated event raised by the ArbitrumOrbitRouter contract.
type ArbitrumOrbitRouterWhitelistSourceUpdated struct {
...
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) FilterWhitelistSourceUpdated(opts *bind.FilterOpts) (*ArbitrumOrbitRouterWhitelistSourceUpdatedIterator, error) {

	logs, sub, err := _ArbitrumOrbitRouter.contract.FilterLogs(opts, "WhitelistSourceUpdated")
	if err != nil {
		return nil, err
	}
	return &ArbitrumOrbitRouterWhitelistSourceUpdatedIterator{contract: _ArbitrumOrbitRouter.contract, event: "WhitelistSourceUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event WhitelistSourceUpdated(address newSource)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) WatchWhitelistSourceUpdated(opts *bind.WatchOpts, sink chan<- *ArbitrumOrbitRouterWhitelistSourceUpdated) (event.Subscription, error) {

	logs, sub, err := _ArbitrumOrbitRouter.contract.WatchLogs(opts, "WhitelistSourceUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ArbitrumOrbitRouterWhitelistSourceUpdated)
				if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "WhitelistSourceUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event WhitelistSourceUpdated(address newSource)
func (_ArbitrumOrbitRouter *ArbitrumOrbitRouterFilterer) ParseWhitelistSourceUpdated(log types.Log) (*ArbitrumOrbitRouterWhitelistSourceUpdated, error) {
	event := new(ArbitrumOrbitRouterWhitelistSourceUpdated)
	if err := _ArbitrumOrbitRouter.contract.UnpackLog(event, "WhitelistSourceUpdated", log); err != nil {
		return nil, err
	}
...
func CreateArbitrumOrbitRouterDeploymentCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "deploy",
		Short: "Deploy a new ArbitrumOrbitRouter contract",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			address, deploymentTransaction, _, deploymentErr := DeployArbitrumOrbitRouter(
				transactionOpts,
				client,
			)
...
func CreateCounterpartGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Call the CounterpartGateway view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			contract, contractErr := NewArbitrumOrbitRouter(contractAddress, client)
			if contractErr != nil {
				return contractErr
			}
			...
			session := ArbitrumOrbitRouterCallerSession{
				Contract: &contract.ArbitrumOrbitRouterCaller,
				CallOpts: callOpts,
			}
...
func CreateGetOutboundCalldataCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Call the GetOutboundCalldata view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateInboxCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "inbox",
		Short: "Call the Inbox view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateL1TokenToGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Call the L1TokenToGateway view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateOwnerCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "owner",
		Short: "Call the Owner view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateRouterCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "router",
		Short: "Call the Router view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateCalculateL2TokenAddressCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Call the CalculateL2TokenAddress view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateGetGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "get-gateway",
		Short: "Call the GetGateway view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateSupportsInterfaceCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Call the SupportsInterface view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateWhitelistCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "whitelist",
		Short: "Call the Whitelist view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateDefaultGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "default-gateway",
		Short: "Call the DefaultGateway view method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if contractAddressRaw == "" {
				return fmt.Errorf("--contract not specified")
			} else if !common.IsHexAddress(contractAddressRaw) {
...
func CreateInitializeCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "initialize",
		Short: "Execute the Initialize method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			session := ArbitrumOrbitRouterTransactorSession{
				Contract:     &contract.ArbitrumOrbitRouterTransactor,
...
func CreateUpdateWhitelistSourceCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Execute the UpdateWhitelistSource method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetGateways0Command() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "set-gateways-0",
		Short: "Execute the SetGateways0 method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateOutboundTransferCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Execute the OutboundTransfer method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateOutboundTransferCustomRefundCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Execute the OutboundTransferCustomRefund method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetGateway2Command() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "set-gateway-2",
		Short: "Execute the SetGateway2 method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetGatewaysCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "set-gateways",
		Short: "Execute the SetGateways method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetOwnerCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "set-owner",
		Short: "Execute the SetOwner method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateFinalizeInboundTransferCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Execute the FinalizeInboundTransfer method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetDefaultGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Execute the SetDefaultGateway method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetGateway0Command() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "set-gateway-0",
		Short: "Execute the SetGateway0 method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetGateway1Command() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "set-gateway-1",
		Short: "Execute the SetGateway1 method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreatePostUpgradeInitCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Execute the PostUpgradeInit method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetDefaultGateway0Command() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Execute the SetDefaultGateway0 method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
func CreateSetGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "set-gateway",
		Short: "Execute the SetGateway method on a ArbitrumOrbitRouter contract",
		PreRunE: func(cmd *cobra.Command, args []string) error {
			if keyfile == "" {
				return fmt.Errorf("--keystore not specified")
			}
...
var ErrNoRPCURL error = errors.New("no RPC URL provided -- please pass an RPC URL from the command line or set the ARBITRUM_ORBIT_ROUTER_RPC_URL environment variable")

// Generates an Ethereum client to the JSONRPC API at the given URL. If rpcURL is empty, then it
// attempts to read the RPC URL from the ARBITRUM_ORBIT_ROUTER_RPC_URL environment variable. If that is empty,
// too, then it returns an error.
func NewClient(rpcURL string) (*ethclient.Client, error) {
	if rpcURL == "" {
		rpcURL = os.Getenv("ARBITRUM_ORBIT_ROUTER_RPC_URL")
	}
...
func CreateArbitrumOrbitRouterCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "arbitrum-orbit-router",
		Short: "Interact with the ArbitrumOrbitRouter contract",
	...
	cmdDeployArbitrumOrbitRouter := CreateArbitrumOrbitRouterDeploymentCommand()
	cmdDeployArbitrumOrbitRouter.GroupID = DeployGroup.ID
	cmd.AddCommand(cmdDeployArbitrumOrbitRouter)
