...
// seer version: 0.3.5
// seer command: seer evm generate --package OwnershipFacet --cli --struct OwnershipFacet --output bindings/utils/diamonds/OwnershipFacet/OwnershipFacet.go
...
var OwnershipFacetMetaData = &bind.MetaData{
	...
	Bin: "",
}
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if safeAddress != "" {
				...
				deployBytecode, err := generateOwnershipFacetDeployBytecode()
				if err != nil {
...
func generateOwnershipFacetDeployBytecode() ([]byte, error) {
	abiPacked, err := OwnershipFacetMetaData.GetAbi()
	if err != nil {
	...
	deployBytecode := append(common.FromHex(OwnershipFacetMetaData.Bin), constructorArguments...)
...
func CreateTransferOwnershipCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if safeAddress != "" {
				abi, err := OwnershipFacetMetaData.GetAbi()
				if err != nil {
